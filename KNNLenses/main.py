...
def main():
    ...
    while a < 30:  # Repete todo_o processo 30 vezes
        ...
        while iteracao1 < T and totalerros > 0:
            ...
            while k < 7 and iteracao1 == 0:  # MELHOR K | olha 3 vezes | Só executa na primeira iteração de T
        ...
        while iteracao1 < T and totalerros > 0:
            # print(f'\n>>>>>>> Iteração: {iteracao1} <<<<<<<')
            while k < 7:  # MELHOR K | olha 3 vezes | Executa em todas as iterações de T
